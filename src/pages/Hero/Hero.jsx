...
import resume from "../../assets/rds.pdf";
...
const profile = {
    ...
    title: 'Frontend Developer | Full-Stack Developer | Cloud Enthusiast | Problem Solver',
    skills: [
        'React', 'React-Native', 'Redux', 'Tailwind', 'Express',
  ...
  return (
    <>
      <main className="bg-[#020617] text-white min-h-screen  pt-10 sm:pt-10">
        <section
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  JavaScript lover 🚀 | React & React-Native | Crafting frameworks
